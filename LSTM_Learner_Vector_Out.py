...
if __name__ == '__main__':
    ...
    # load dataset
    aggregated_series = learner.read_data(init_object.data_path + "aggregated_energy_co_daypre.csv")
    ...
    with open(init_object.model_path + "model1_master.json", "w") as json_file:
        json_file.write(model_json)
    # serialize weights to HDF5
    model.save_weights(init_object.model_path + "model1_master.h5")
