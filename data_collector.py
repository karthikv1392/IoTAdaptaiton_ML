...
class DataLoader():
    ...
    def load_data_history(self):
        ...
        df = pd.read_csv("$CUPPROJECTPATH/results/wisen_simulation.csv",sep=";")   # Load the csv into a dataframe
        ...
        with open("$CUPPROJECTPATH/results/wisen_simulation.csv") as csvfile:
    ...
    def process_data(self,data_frame):
        ...
        aggregate_df.to_csv(self.data_path +"master_energy.csv",index=True)
